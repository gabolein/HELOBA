...
REG_TYPE RegSettings[MAX_REG] = {
    ...
    {PREAMBLE_CFG1, 0x20}, // Preamble Length Configuration Reg. 1 (reset);
    ...
    {SYMBOL_RATE2,
     0x3f}, // Symbol Rate Configuration Exponent and Mantissa [1..
    ...
    {SETTLING_CFG,
     0x0b},           // Frequency Synthesizer Calibration and Settling Con..
...
REG_TYPE ExtRegSettings[MAX_EXT_REG] = {
    ...
    {PA_IFAMP_TEST,
     0x00},              // Power Amplifier Intermediate Frequency Amplifier T..
